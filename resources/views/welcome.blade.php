        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fas fa-5x fa-cubes mb-3 color1 sr-icons"></i>
              <h3 class="mb-3 color1 secondary-font font-600">Packs</h3>
              <p class="text-muted mb-0 color2 secondary-font">Access ready-made packs</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fab fa-5x fa-kickstarter mb-3 color1 sr-icons"></i>
              <h3 class="mb-3 color1 secondary-font font-600">Kickstarter</h3>
              <p class="text-muted mb-0 color2 secondary-font">Support our campaign at Kickstarter!</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fab fa-5x fa-github mb-3 color1 sr-icons"></i>
              <h3 class="mb-3 color1 secondary-font font-600">GitHub</h3>
              <p class="text-muted mb-0 color2 secondary-font">Check out the repo</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fas fa-5x fa-globe mb-3 color1 sr-icons"></i>
              <h3 class="mb-3 color1 secondary-font font-600">Join!</h3>
              <p class="text-muted mb-0 color2 secondary-font">Register to be a part of this </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="my-4">
            <p class="mb-5 color2 secondary-font">Send pull requests and then get in touch with us on this email and we'd happy for you to join us!</p>
          </div>
        </div>
        <div class="row">
